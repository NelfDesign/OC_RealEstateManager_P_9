 ...
 */
class PropertyListAdapter(private val properties : List<Property>, private val listener : PropertyListAdapterListener?) : RecyclerView.Adapter<PropertyListAdapter.ViewHolder>(),
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       ...
       with(holder){
           ...
           /*Glide.with(this.cardView)
               .load(property.photos!![0].urlPhoto)
